/*
p2p block generator : It will create a block from the txn available in the input
file = "n_txn.txt" (where n= 100,200.....2500). You have change the input file
name according to that i.e 100_txn.txt, 2500_txn.txt etc.

Compilation command : $ g++ -I../protos p2p_blockGenerator.cpp -o
p2p_blockGenerator ../protos/transaction.pb.cc ../protos/block.pb.cc -lprotobuf
...
// int main() {
//   try {
//     Block latestBlock = blockProducer("2500_txn.txt");
