/*
txn generator : It will create n number of transaction.(n= 100, 200, ......2500
etc)

Compilation command : $ g++ -I../protos txnGenerator.cpp -o txnGenerator
../protos/transaction.pb.cc -lprotobuf

run : ./txnGenerator 2500 <-- this will create 2500_txn.txt with 2500 txn
*/
#include <fstream>
#include <iostream>
#include <random>
