/*
p2p block sender : It will recevie the block from block generator and check the
validity of that block . If received a valid block it will store the block into
the leveldb.

Compilation command: $ g++ -std=c++17 -I../protos -I../blocksDB -I../merkleTree
p2p_blockSender.cpp p2p_blockGenerator.cpp ../protos/transaction.pb.cc
../protos/block.pb.cc -o p2p_blockSender -lprotobuf -lleveldb -lssl -lcrypto
-lpthread
